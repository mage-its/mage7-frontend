              ...
              <div id="sidebar-background-mobile">
                ...
                <div class="sidebar-body">
                  <ul class="list-unstyled components text-white">
                    ...
                    <li @click="selectedItem = 1" class="mb-3">
                      <router-link
                        class="text-white"
                        :to="{ name: 'MainParticipant' }"
                      >
                        <b-row>
                          <b-col cols="1" lg="1">
                            <div class="inline">
